    ...
    <div className="flex min-h-dvh flex-col items-center justify-center bg-background px-6 text-on-background">
      <main className="flex w-full max-w-[320px] flex-col items-center gap-8 text-center">
        ...
        <div className="flex w-full flex-col gap-3">
          <div
            role="alert"
            className="fade-in-up w-full rounded-lg border border-error-container bg-surface-error px-4 py-3 text-left text-body-md text-text-error"
          >
            Google didn't let me in — try again?
          </div>
